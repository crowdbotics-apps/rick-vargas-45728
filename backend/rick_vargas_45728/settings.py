"""
Django settings for rick_vargas_45728 project.
...
ROOT_URLCONF = 'rick_vargas_45728.urls'
...
WSGI_APPLICATION = 'rick_vargas_45728.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rick_vargas_45728 API",
    "DESCRIPTION": "API documentation for rick_vargas_45728 App",
    "VERSION": "v1",
}
